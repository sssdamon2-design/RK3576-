...
int main(void)
{
    ...
    printf(
        ...
        "========================================\n"
        "Enter : capture one image\n"
        "q     : quit\n"
        "\n"
        "Before each Enter:\n"
        "move camera / change distance / "
        "change light / change scene.\n"
        "\n"
    );
    ...
    while (1)
    {
             ...
             i++)
        {
            ...
            struct v4l2_plane discard_planes[1];
